 ...
 * @author msadik
 */
public class CycleVieFabrtearch extends SearchBase implements Serializable {
	...
	public List specificExecute(Serializable searchBean, SearchConfig config, String sortField, String sortOrder) {
		...
		return referentielService.findCycleByDeliv(criteria);
	}
}
