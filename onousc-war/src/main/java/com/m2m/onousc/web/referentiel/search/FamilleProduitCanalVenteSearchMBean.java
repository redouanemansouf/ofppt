...
@ManagedBean
@ViewScoped
public class FamilleProduitCanalVenteSearchMBean extends AbstractSearchMBean {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1832608462227457169L;
	 ...
	 */
	public FamilleProduitCanalVenteSearchMBean() {
		search = new FamilleProduitCanalVenteSearch();
