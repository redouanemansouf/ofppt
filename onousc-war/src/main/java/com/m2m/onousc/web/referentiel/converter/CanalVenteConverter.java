 ...
 * @author msadik
 */
@FacesConverter("canalVenteConverter")
public class CanalVenteConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component,
		...
		if (value != null && value.trim().length() > 0) {
			try {
				...
				return servicePres.findCanalVente(Long.parseLong(value));
	...
	public String getAsString(FacesContext context, UIComponent component,
			Object value) {
		if (value != null) {
			return String.valueOf(((CanalVenteVO) value).getId());
		} else {
			return null;
		}
	}
