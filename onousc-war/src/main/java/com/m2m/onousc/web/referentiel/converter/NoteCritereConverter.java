...
@FacesConverter("noteCritereConverter")
public class NoteCritereConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component,
		...
		if (value != null && value.trim().length() > 0) {
			try {
				...
				return servicePres.findNoteCritere(Long.parseLong(value));
			} catch (NumberFormatException e) {
				throw new ConverterException(new FacesMessage(
						FacesMessage.SEVERITY_ERROR, "Erreur de conversion",
						"Veuillez choisir une n"));
			}
		} else {
			return null;
		}
	...
	public String getAsString(FacesContext context, UIComponent component,
			Object value) {
		if (value != null) {
			return String.valueOf(((NoteCritereVO) value).getId());
		} else {
			return null;
		}
	}
