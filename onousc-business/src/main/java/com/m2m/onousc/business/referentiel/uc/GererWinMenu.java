 ...
 * @author iissouani
 */
@Service("ADMINISTRATION_GererWinMenu_UC")
public class GererWinMenu extends UseCaseController {
	...
	protected ProcessResult business() {
		if (UserContext.getClientParameters().getSousCommand()
				.equals(Constantes.SOUS_COMMAND_CREER_WIN_MENU)) {

			WinMenu subjet = (WinMenu) UserContext.getSubject();
			WinMenu creation1 = new WinMenu();
			
			//first page
			creation1.setOperateur(subjet.getOperateur());
			...
			//second page
			creation2.setOperateur(subjet.getOperateur());
			...
			//third page
			creation3.setOperateur(subjet.getOperateur());
			...
			//fourth page
			creation4.setOperateur(subjet.getOperateur());
			...
			//fifth page
			creation5.setOperateur(subjet.getOperateur());
			...
			//sixth page
			creation6.setOperateur(subjet.getOperateur());
			...
			//seventh page
			creation7.setOperateur(subjet.getOperateur());
			...
			//eight page
			creation8.setOperateur(subjet.getOperateur());
			...
			//nine page
			creation9.setOperateur(subjet.getOperateur());
			...
			//tenth page
			creation10.setOperateur(subjet.getOperateur());
			...
			GroupUser creationg = new GroupUser();
			
			creationg.setGroupname(subjet.getOperateur());
			creationg.setStatut(EntityStatus.ENABLED);
//			
//			//eleventh page
//			creation11.setOperateur(subjet.getOperateur());
...
//			
//			
			groupuserDaoJpa.persist(creationg);
