...
public class TourniquetCriteria extends BaseCriteria implements Serializable {
	...
	public TourniquetCriteria(String code, String libelle, String libcite,
			String reference, EntityStatus statut, SearchConfig config) {
		super();
		this.code = code;
