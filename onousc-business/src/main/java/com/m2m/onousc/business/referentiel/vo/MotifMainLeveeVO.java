...
public class MotifMainLeveeVO implements ValueObject, ISearchResultVO{
	...
	public MotifMainLeveeVO(){
		super();
	}
	
	
	
	public MotifMainLeveeVO(String libelle) {
		super();
	...
	@Override
	public ITransformer<MotifMainLevee, MotifMainLeveeVO> getTransformer() {
		return new MotifMainLeveeVOTransformer();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MotifMainLeveeVO other = (MotifMainLeveeVO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
