...
import com.m2m.onousc.business.referentiel.rule.CiteBusinessRuleManager;
 ...
 *
 */
@Service("REFERENTIEL_GererCite_UC")
public class GererCite extends UseCaseController{

	@Override
	protected IBusinessRuleManager getBusinessRuleManager() {
		return new CiteBusinessRuleManager();
	}
