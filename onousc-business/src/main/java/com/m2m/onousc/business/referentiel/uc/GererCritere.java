...
import com.m2m.onousc.business.referentiel.rule.CritereBusinessRuleManager;
...
@Service("REFERENTIEL_GererCritere_UC")
public class GererCritere extends UseCaseController {

	@Override
	protected IBusinessRuleManager getBusinessRuleManager() {
		return new CritereBusinessRuleManager();
	}
