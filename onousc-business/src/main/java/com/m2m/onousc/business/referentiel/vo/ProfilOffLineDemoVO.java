...
public class ProfilOffLineDemoVO implements ValueObject, ISearchResultVO {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7644646379888437799L;
	...
	public ProfilOffLineDemoVO() {
		super();
	}

	public ProfilOffLineDemoVO(Long id, String libelle, String code, Double debitplafond, Double plafondRechargement,
			Integer periode, String devise, String banque, String typeCarte, String paiment, EntityStatus statut) {
		super();
		this.id = id;
	...
	public int hashCode() {
		...
		result = prime * result + ((debitplafond == null) ? 0 : debitplafond.hashCode());
		...
		result = prime * result + ((plafondRechargement == null) ? 0 : plafondRechargement.hashCode());
		result = prime * result + ((statut == null) ? 0 : statut.hashCode());
		result = prime * result + ((typeCarte == null) ? 0 : typeCarte.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProfilOffLineDemoVO other = (ProfilOffLineDemoVO) obj;
		if (banque == null) {
