...
public class ParametreGeneralCriteria extends BaseCriteria implements Serializable{
	...
	public ParametreGeneralCriteria(){
		super();
		this.code = null;
		this.libelle = null;
	}

	public ParametreGeneralCriteria(String code, String libelle, EntityStatus statut, SearchConfig config) {
		super();
		this.code = code;
