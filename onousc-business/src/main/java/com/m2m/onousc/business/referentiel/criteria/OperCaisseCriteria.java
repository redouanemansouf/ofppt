 ...
 * 
 */
public class OperCaisseCriteria extends BaseCriteria implements Serializable {
	...
	public OperCaisseCriteria() {
	}

	public OperCaisseCriteria(String typeOperation, Date dateDebut, Date dateFin, String matricule, Long idcaisse) {
		super();
