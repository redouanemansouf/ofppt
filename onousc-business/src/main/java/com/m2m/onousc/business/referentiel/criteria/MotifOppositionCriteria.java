...
public class MotifOppositionCriteria extends BaseCriteria implements Serializable{
	...
	public MotifOppositionCriteria(){
		super();
		this.code = null;
		this.libelle = null;
	}

	public MotifOppositionCriteria(String code, String libelle, EntityStatus statut, SearchConfig config) {
		super();
		this.code = code;
