 ...
 * @author msadik
 */
public class CarteCriteria extends BaseCriteria implements Serializable {
	...
	public CarteCriteria(String numSerie, Long numPorteur, String operation, String numeroCarte, Long idCite) {
		super();
