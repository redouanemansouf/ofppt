...
public class ParametreGeneralVO implements ValueObject, ISearchResultVO{
	...
	public ParametreGeneralVO(){
		super();
	}
	
	
	
	public ParametreGeneralVO(String libelle) {
		super();
	...
	@Override
	public ITransformer<ParametreGeneral, ParametreGeneralVO> getTransformer() {
		return new ParametreGeneralVOTransformer();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ParametreGeneralVO other = (ParametreGeneralVO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
